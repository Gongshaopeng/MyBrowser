...
@interface GSAddpopupsView ()<UIGestureRecognizerDelegate>
...
@implementation GSAddpopupsView
...
//            [self.lastWindow removeFromSuperview];
        });
    }
...
//    }
    return rootWindow;
//    return __kAppDelegate__.window;
